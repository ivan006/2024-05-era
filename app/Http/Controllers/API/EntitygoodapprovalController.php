...
use App\Models\Entitygoodapproval;
use Illuminate\Http\Request;

class EntitygoodapprovalController extends Controller
{
    protected $itemNameSingular = "Entitygoodapproval";
    protected $model;

    public function __construct()
    {
        $this->model = new Entitygoodapproval();
    }
