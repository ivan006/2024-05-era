...
use App\Models\Externalproducer;
use Illuminate\Http\Request;

class ExternalproducerController extends Controller
{
    protected $itemNameSingular = "Externalproducer";
    protected $model;

    public function __construct()
    {
        $this->model = new Externalproducer();
    }
